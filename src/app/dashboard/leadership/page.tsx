/*
 * /dashboard/leadership (Gate 3.5 Step 2 rebuild).
 *
 * Three-section overview for Ameet + leadership: "Are we making money?"
 * + "Are we delivering?" + "Needs leadership attention". Two big
 * navigation tiles below (Finance health / Operations health). No
 * sidebar, no recent-activity feed; intentionally minimal because
 * Ameet's time is the constraint.
 *
 * Reads the canonical data files directly. KPI math lives in
 * src/lib/dashboard/leadershipData.ts so /admin Step 8 can share the
 * top section without duplicating logic.
 */
...
function MoneySection({ data }: { data: FinancialHealth }) {
  return (
    <section
    ...
    >
      ...
      <div className="mt-4 grid grid-cols-2 gap-4 sm:grid-cols-4">
        ...
        <Kpi
          label="Outstanding"
          value={formatRs(data.outstanding)}
        />
        <Kpi
          label="Schools"
