...
// Strict-gate tests: force production-mode so the PI / schedule
// affordance hides for Ops + SalesRep + SalesHead + TrainerHead.
// Testing-open default opens EDIT for every active user.
