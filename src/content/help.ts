...
export const HELP_GLOSSARY: GlossaryItem[] = [
  ...
  {
    term: 'GSTIN',
    definition: 'The 15-character GST identification number for a school. Required before a PI can be generated. Edit on the school record at /schools/[id]/edit. The "Schools needing data" tile on the kanban surfaces every school still missing one.',
  },
  {
    term: 'Idempotent',
  ...
  {
    term: '"Schools needing data" tile',
    definition: 'The amber banner above the kanban that surfaces schools missing GSTIN, email, contact person, or PIN code. Click to navigate to /schools sorted "most missing first" so triage hits the worst cases at the top.',
  },
  {
    term: 'SPOC',
...
export const HELP_WORKFLOWS: WorkflowItem[] = [
  ...
  {
    task: 'Editing a school’s GSTIN (unblock PI generation)',
    steps: [
      'Go to /schools and find the school. Or click the "Schools needing data" tile on the kanban for the triage list.',
      'Click into the school. Click Edit on the detail page.',
      'Update the GSTIN field. Save changes.',
      'PI generation on every MOU for that school is now unblocked. The change is visible immediately.',
    ],
  },
  {
