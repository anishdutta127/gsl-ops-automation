...
The deferred-items registry has grown across W4-A through W4-F to 27 entries. The round-2 testing email risks becoming substantial if every entry surfaces flat. Composition guidance for W4-I:
...
- **Estimate testing time per role.** A Sales tester reviewing D-006 + D-011 + D-022 + D-024 + D-026 needs ~45 minutes; an Ops tester reviewing D-002 / D-009 / D-013 / D-019 / D-020 / D-023 needs ~30 minutes; Finance D-005 / D-007 alone is ~10 minutes. Setting expectations up front improves response quality.
