...
The deferred-items registry has grown across W4-A through W4-G to 37 entries. The round-2 testing email risks becoming substantial if every entry surfaces flat. Composition guidance for W4-I:
