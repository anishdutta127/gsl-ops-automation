...
Mock GitHub Contents API: first PUT 200, second PUT 409, retry 200 with merged state. Assert both entries land. Assert `retryCount === 1` on the loser.
...
**Launch gate**: all 11 flows working end-to-end against real seeded data.
